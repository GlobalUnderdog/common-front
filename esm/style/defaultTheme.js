...
var defaultFontTheme = {
    ...
    h1: {
        css: function () { return css(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n      font-size: 64px;\n    "], ["\n      font-size: 64px;\n    "]))); },
    },
    h2: {
        css: function () { return css(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n      font-size: 52px;\n    "], ["\n      font-size: 52px;\n    "]))); },
    },
    h3: {
        css: function () { return css(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n      font-size: 48px;\n    "], ["\n      font-size: 48px;\n    "]))); },
    },
    h4: {
        css: function () { return css(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n      font-size: 36px;\n    "], ["\n      font-size: 36px;\n    "]))); },
    },
    h5: {
        css: function () { return css(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n      font-size: 24px;\n      text-transform: uppercase;\n    "], ["\n      font-size: 24px;\n      text-transform: uppercase;\n    "]))); },
    },
    h6: {
