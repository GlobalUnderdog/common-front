var minWidth=function minWidth(px){return"(min-width: ".concat(px,"px)");};var maxWidth=function maxWidth(px){return"(max-width: ".concat(px,"px)");};var media='@media screen and';export var Breakpoints={small:767,medium:768,large:992,xlarge:1200};export var mediaQuery={/**
   ...
   */xlarge:"".concat(media," ").concat(minWidth(Breakpoints.xlarge))};