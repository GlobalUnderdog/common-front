import { createContext, useContext, createElement, Fragment as Fragment$1, forwardRef, useEffect, useState } from 'react';
...
import { ThemeProvider, useTheme, Global, keyframes, css } from '@emotion/react';
export { Global, ThemeProvider, css, jsx, keyframes, useTheme } from '@emotion/react';
...
var Children = function (_a) {
    ...
    return (jsxs(Fragment$1, { children: [jsx(Global, { styles: theme.global.css(theme) }, void 0),
            jsx(Global, { styles: theme.modal.css(theme) }, void 0),
            jsx(ScreenClassProvider, { children: children }, void 0)] }, void 0));
};
var GUProvider = function (_a) {
    var children = _a.children, theme = _a.theme;
    return (jsx(ThemeProvider, __assign({ theme: theme }, { children: jsx(Children, { children: children }, void 0) }), void 0));
};
...
var guDefaultTheme = {
    ...
    textArea: {
        css: function (theme) { return css(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n      ", "\n\n      & > textarea {\n        display: block;\n        height: 290px;\n        padding: 4px;\n        resize: none;\n      }\n    "], ["\n      ", "\n\n      & > textarea {\n        display: block;\n        height: 290px;\n        padding: 4px;\n        resize: none;\n      }\n    "])), inputTextAreaBase(theme)); },
    },
    checkbox: {
...
var GUCheckbox = function (_a) {
    ...
    var theme = useTheme();
    return (jsx("div", __assign({ css: theme.checkbox.css(theme, props), className: className }, { children: labelFirst ? (jsxs(Fragment$1, { children: [label && jsx("label", __assign({ htmlFor: props.id }, { children: label }), void 0),
                jsx("input", __assign({}, props, { type: 'checkbox' }), void 0)] }, void 0)) : (jsxs(Fragment$1, { children: [jsx("input", __assign({}, props, { type: 'checkbox' }), void 0),
...
var GUInput = function (_a) {
    ...
    return (jsx("div", __assign({ css: theme.input.css(theme, props), className: className }, { children: labelSecond ? (jsxs(Fragment$1, { children: [jsx("input", __assign({}, props), void 0),
                label && jsx("label", __assign({ htmlFor: props.id }, { children: label }), void 0)] }, void 0)) : (jsxs(Fragment$1, { children: [label && jsx("label", __assign({ htmlFor: props.id }, { children: label }), void 0),
...
var NavLink = function (_a) {
    ...
    if (child) {
        return href ? (jsx(Link, __assign({ href: href, passHref: true }, { children: child }), void 0)) : (jsx(Fragment$1, { children: child }, void 0));
    }
...
var GUNavbar = function (_a) {
    ...
    return (jsxs(Fragment$1, { children: [jsx(Global, { styles: globalVariables(links.length) }, void 0),
...
var GURadio = function (_a) {
    var className = _a.className, label = _a.label, labelFirst = _a.labelFirst, props = __rest(_a, ["className", "label", "labelFirst"]);
    var theme = useTheme();
    return (jsx("div", __assign({ css: theme.radio.css(theme, props), className: className }, { children: labelFirst ? (jsxs(Fragment$1, { children: [label && jsx("label", __assign({ htmlFor: props.id }, { children: label }), void 0),
                jsx("input", __assign({}, props, { type: 'radio' }), void 0)] }, void 0)) : (jsxs(Fragment$1, { children: [jsx("input", __assign({}, props, { type: 'radio' }), void 0),
                label && jsx("label", __assign({ htmlFor: props.id }, { children: label }), void 0)] }, void 0)) }), void 0));
};
...
var SlideFade = function (_a) {
    ...
    return (jsx(Reveal, __assign({}, props, { keyframes: animation(direction !== null && direction !== void 0 ? direction : 'left', distance !== null && distance !== void 0 ? distance : '100%') }), void 0));
};
...
var GUTextArea = function (_a) {
    ...
    var theme = useTheme();
    var label = props.label;
    return (jsx("div", __assign({ css: theme.textArea.css(theme, props), className: className }, { children: labelSecond ? (jsxs(Fragment$1, { children: [jsx("textarea", __assign({}, props), void 0),
                label && jsx("label", __assign({ htmlFor: props.id }, { children: label }), void 0)] }, void 0)) : (jsxs(Fragment$1, { children: [label && jsx("label", __assign({ htmlFor: props.id }, { children: label }), void 0),
